...
internal class ListaPagamentosFragment : BaseFragment() {
    ...
    ): View? = inflater.inflate(R.layout.lista_pagamentos, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.todos().observe(this, Observer {
            it?.let { pagamentosEncontrados -> adapter.add(pagamentosEncontrados) }
        })
